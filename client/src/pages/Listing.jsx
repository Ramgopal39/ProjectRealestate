...
import { FaBath, FaChair, FaMapMarkerAlt } from "react-icons/fa";
   ...
   return <main>
    ...
    {listing && !loading && !error && (
     ...
     <Swiper navigation pagination modules={[Navigation, Pagination]}>
      ...
      {copied && (
        <p className="fixed top-[23%] right-[5%] z-10 rounded-md bg-slate-100 p-2">Link copied to clipboard!</p>
      )}
      <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
          ...
          <div className="flex gap-4">
            ...
            {
              listing.offer && (
                <p className="bg-green-700 w-full max-w-[200px] text-white text-center p-1 rounded-md">${+listing.regularPrice - +listing.discountPrice}</p> 
              )
            }
        </div>
