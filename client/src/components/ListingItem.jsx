        ...
        w-full sm:w-[330px]'>
            ...
            <div className='p-3 flex flex-col gap-2 w-full'>
                ...
                <div className='flex items-center justify-between gap-2'>
                    <a
                      className='flex items-center gap-1 text-sm text-slate-600 hover:underline truncate'
                    ...
                    {listing.contactNumber && (
                      <a href={`tel:${listing.contactNumber}`} className='flex items-center gap-1 text-sm text-slate-600 hover:underline shrink-0'>
                        <FaPhone className='text-green-700 h-4 w-4'/> {listing.contactNumber}
                      </a>
                    )}
                </div>
